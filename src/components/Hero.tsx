...
const Hero = () => {
  ...
  return (
    <div className="relative h-screen min-h-[600px] w-full overflow-hidden">
      {/* Video Background */}
      <div className="absolute inset-0 w-full h-full bg-[url(./assets/premium_photo-1661883237884-263e8de8869b.jpg)] bg-cover bg-center">
        {/* <video
          autoPlay
          muted
          loop
        ...
        >
          <source src="https://drive.google.com/uc?export=download&id=1SPxtbwWL0yIgCTvXbnTeMBWu1EFnf2wo" type="video/mp4" />
