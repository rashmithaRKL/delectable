          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link 
              ...
              className={`font-medium transition-colors hover:text-restaurant-burgundy ${
                isActive('/') ? 'text-restaurant-burgundy' : 'text-foreground'
              }`}
            >
              Home
            </Link>
            <Link 
              to="/about" 
              className={`font-medium transition-colors hover:text-restaurant-burgundy ${
                isActive('/about') ? 'text-restaurant-burgundy' : 'text-foreground'
              }`}
            >
              About
            </Link>
            <Link 
              to="/menu" 
              className={`font-medium transition-colors hover:text-restaurant-burgundy ${
                isActive('/menu') ? 'text-restaurant-burgundy' : 'text-foreground'
              }`}
            >
              Menu
            </Link>
            <Link 
              to="/contact" 
              className={`font-medium transition-colors hover:text-restaurant-burgundy ${
                isActive('/contact') ? 'text-restaurant-burgundy' : 'text-foreground'
              }`}
            >
              Contact
            </Link>
